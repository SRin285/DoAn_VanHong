                ...
                if (data.message.length > 0) {
                    data.message.forEach((schedule, index) => {
                        ...
                        if (index === data.message.length - 1 && schedule.isDisable === true) {
                            html += `<div>
                            Không có lượt truy cập theo lịch trình trong khung thời gian hiện tại. Vui lòng chọn các kỳ thi theo lịch trình tiếp theo.
                            </div>`
                        }
                        ...
                        moreInfo = `
                         <div class="d-flex flex-column">
                                    ...
                                    <span class="d-block pt-2">giá khám : 500.000$ chưa phí bổ sung</span>
                                </div>
                    ...
                    html = `
                            <div>
                                 bác sĩ "${data.doctor.name}" không có một cuộc hẹn vào <b>${value}</b>. Vui lòng chọn lịch kiểm tra tiếp theo.
                            </div>
                    `;
                    moreInfo = '';
                }
                ...
                if (data.message.length > 0) {
                    ...
                    html = `
                            <div class="no-schedule">
                                 ...
                                 Doctor "${data.doctor.name}" không có một cuộc hẹn vào <b>${value}</b>. Vui lòng chọn lịch kiểm tra tiếp theo
